 ...
 * NSI
 *
 * Copyright (c) 2002 AGEFOS-PME, Inc. All Rights Reserved.
 *
 * This software is the proprietary information of AGEFOS-PME, Inc.
 *
 */
...
/**
 * @author Piyush To change the template for this generated sype comment go to Window>Preferences>Java>Code
 *         Generation>Code and Comments
 */
public class ConfigurationPanel extends ZPanel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7761230551996308474L;
	
	public ConfigurationPanel(String title, int nbColumns) {
		super(title);
		compose(nbColumns);
	}
	...
	private void compose(int nbColumns) {
		...
		setBorder(new TitledBorder(new EmptyBorder(0, 0, 0, 0), getName(), TitledBorder.LEFT, TitledBorder.TOP));
	...
	protected void addButton(String iconName, String rolloverIconName, String description, Action action) {
		if (action == null) {
	...
	protected static Action getApplicationAction(ActionDescription actionDescription) {
		if (null != actionDescription) { return HotelFullClientApplication.getApplication()
				.getAction(actionDescription); }
		return null;
	}
