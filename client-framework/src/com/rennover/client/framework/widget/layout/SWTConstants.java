...
public class SWTConstants
{
	 ...
	 * Note that this is a <em>HINT</em>. It is ignored on all platforms
	 * except Motif.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * style constant for selection hiding behavior. (value is 1&lt;&lt;15) <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	 ...
	 * since FULL_SELECTION and SMOOTH share the same value, but are implemented
	 * on non-intersecting sets of widgets) <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	...
	/**
	 * style constant for flat appearance. (value is 1&lt;&lt;16, since
	 * FULL_SELECTION and SMOOTH share the same value, but are implemented on
	 * non-intersecting sets of widgets) <br>
	 * Note that this is a <em>HINT</em>.
	 * <p>
	 * <b>Used By:</b>
	 * <ul>
	 ...
	 * current background color. When this style is specified, the background is
	 * not filled, and the application is responsible for filling every pixel of
	 * the client area. This style might be used as an alternative to
	...
	/**
	 * <code>MessageBox</code> style constant for error icon behavior (value
	 * is 1)
	 */
	public static final int ICON_ERROR = 1;

	/**
	 * <code>MessageBox</code> style constant for information icon behavior
	 * (value is 1&lt;&lt;1)
	 */
	public static final int ICON_INFORMATION = 1 << 1;

	/**
	 * <code>MessageBox</code> style constant for question icon behavior
	 * (value is 1&lt;&lt;2)
	 */
	public static final int ICON_QUESTION = 1 << 2;

	/**
	 * <code>MessageBox</code> style constant for warning icon behavior (value
	 * is 1&lt;&lt;3)
	 */
	public static final int ICON_WARNING = 1 << 3;

	/**
	 * <code>MessageBox</code> style constant for "working" icon behavior
	 * (value is 1&lt;&lt;4)
	 */
	public static final int ICON_WORKING = 1 << 4;

	/**
	 * <code>MessageBox</code> style constant for an OK button. Valid
	 * combinations are OK, OK|CANCEL (value is 1&lt;&lt;5)
	 */
	public static final int OK = 1 << 5;

	/**
	 * <code>MessageBox</code> style constant for YES button. Valid
	 * combinations are YES|NO, YES|NO|CANCEL (value is 1&lt;&lt;6)
	 */
	public static final int YES = 1 << 6;

	/**
	 * <code>MessageBox</code> style constant for NO button. Valid
	 * combinations are YES|NO, YES|NO|CANCEL (value is 1&lt;&lt;7)
	 */
	public static final int NO = 1 << 7;

	/**
	 * <code>MessageBox</code> style constant for a CANCEL button. Valid
	...
	/**
	 * <code>MessageBox</code> style constant for an ABORT button. The only
	 * valid combination is ABORT|RETRY|IGNORE (value is 1&lt;&lt;9)
	 */
	public static final int ABORT = 1 << 9;

	/**
	 * <code>MessageBox</code> style constant for a RETRY button. Valid
	 * combinations are ABORT|RETRY|IGNORE, RETRY|CANCEL (value is 1&lt;&lt;10)
	 */
	public static final int RETRY = 1 << 10;

	/**
	 * <code>MessageBox</code> style constant for an IGNORE button. The only
	 ...
	 * handle line-delimeters (value is 1&lt;&lt;1)
	 */
	 ...
	 * widget class without implementing the <code>checkSubclass()</code>
	 * method. For additional information see the comment in
	 * <code>Widget.checkSubclass()</code> (value is 43)
	 * 
	...
	/**
	 * SWT error constant indicating that an unsatisfied link error occured
	...
	/**
	 * <code>Image</code> constructor argument indicating that the new image
	...
	/**
	 * font style constant indicating a normal weight, non-italic font (value is
	 * 0)
	 */
