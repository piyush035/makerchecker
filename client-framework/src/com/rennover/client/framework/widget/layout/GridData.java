...
public final class GridData
{
	 ...
	 * Possible values are:
	 * 
	 * BEGINNING: Position the control at the top of the cell CENTER: Position
	 * the control in the vertical center of the cell END: Position the control
	 * at the bottom of the cell FILL: Resize the control to fill the cell
	 * vertically
	 */
	public int m_verticalAlignment = CENTER;
	 ...
	 * Possible values are:
	 * 
	 * BEGINNING: Position the control at the left of the cell CENTER: Position
	 * the control in the horizontal center of the cell END: Position the
	 * control at the right of the cell FILL: Resize the control to fill the
	 * cell horizontally
	 */
	public int m_horizontalAlignment = BEGINNING;
	 ...
	 */
	public int m_widthHint = SWTConstants.DEFAULT;
	 ...
	 * The default value is SWT.DEFAULT.
	 */
	public int m_heightHint = SWTConstants.DEFAULT;
	 ...
	 */
	public int m_horizontalIndent = 0;
	 ...
	 */
	public boolean m_grabExcessHorizontalSpace = false;
	 ...
	 * The default value is false.
	 */
	public boolean m_grabExcessVerticalSpace = false;

	// Private
	int m_childIndex;

	boolean m_isItemData = true;
	...
	public GridData(int style)
	{
		...
		{
			m_verticalAlignment = FILL;
		}
		if ((style & VERTICAL_ALIGN_END) != 0)
		{
			m_verticalAlignment = END;
		}

		if ((style & HORIZONTAL_ALIGN_BEGINNING) != 0)
		{
			m_horizontalAlignment = BEGINNING;
		}
		...
		{
			m_horizontalAlignment = FILL;
		}
		if ((style & HORIZONTAL_ALIGN_END) != 0)
		{
			m_horizontalAlignment = END;
		}

		if ((style & GRAB_HORIZONTAL) != 0)
		{
			m_grabExcessHorizontalSpace = true;
		} else
		{
			m_grabExcessHorizontalSpace = false;
		}
		if ((style & GRAB_VERTICAL) != 0)
		{
			m_grabExcessVerticalSpace = true;
		} else
		{
			m_grabExcessVerticalSpace = false;
		}
	}
