...
public class FastSearchList extends ZPanel implements DocumentListener
{
	...
	protected int compareRows(Object row1, Object row2)
	{
		...
		Class type = row1.getClass();
		Object tmpRow1;
		Object tmpRow2;

		if (type.getSuperclass() == java.lang.Number.class)
		{
			tmpRow1 = new Double(((Number) row1).doubleValue());
			tmpRow2 = new Double(((Number) row2).doubleValue());
		} else
		{
			...
			{
				tmpRow1 = row1.toString();
				tmpRow2 = row2.toString();
			}
		}
	...
	public static void main(String[] args)
	{
		...
		FastSearchList fastSearchList = new FastSearchList();
