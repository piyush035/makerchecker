 ...
 * 
 * TablePanel panel = new TablePanel("Elément(s) trouvé(s)", false, true);
 * 
 * ... // création de table1
 * 
 ...
 * 
 */
public class TablePanel extends ZPanel implements TableModelListener, ListSelectionListener
{
	 ...
	 */
	public TablePanel(boolean border)
	{
	 ...
	 *            indique que l'on veut un espace autour du panneau
	 */
	public TablePanel(String title, boolean border)
	{
	 ...
	 *            titre
	 */
	public TablePanel(String title, ZTable table, int nbRowVisible, boolean border, boolean rowCountShowed)
	{
	 ...
	 */
	public TablePanel(String title, boolean border, boolean rowCountShowed)
	{
		super(title);
	...
	/**
	 * Add a spring to the horizontal button panel.
	 */
	public void addHSpring()
	{
		getHorizontalButtonPanel().addSpring();
	}

	/**
	 * Add a spring to the vertical button panel.
	 */
	public void addVSpring()
	{
		getVerticalButtonPanel().addSpring();
	}
